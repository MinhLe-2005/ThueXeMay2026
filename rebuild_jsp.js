...
// 1. Read CSS from part1.txt
let part1 = fs.readFileSync('part1.txt', 'utf8');

// 2. Add extra CSS for box and container-haha
const extraCss = `
            .container-haha {
                border-radius: 12px;
                padding: 38px;
...
// 4. Get the bottom from git file (pagination and scripts)
let gitContent = fs.readFileSync('motorbikes_git.jsp', 'utf8');
...
console.log("Successfully rebuilt motorbikes.jsp!");
