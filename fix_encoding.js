...
const newContent = `            <section style="overflow: visible !important;">
...
const startStr = '<section style="overflow: visible !important;">';
const endStr = '</c:forEach>';
...
if (startIndex !== -1 && endIndex !== -1 && endIndex > startIndex) {
    ...
    fs.writeFileSync('d:/A_JAVA_Ki_5/SWP391/motor-booking/motorcycle-booking-system-main/target/MotorcyleHiringProject-1.0-SNAPSHOT/motorbikes.jsp', finalContent, 'utf8');
