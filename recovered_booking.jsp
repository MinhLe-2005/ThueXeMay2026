...
/*                border-radius: 5px;*/
            ...
            .overlay {
                ...
                width: 100%;
                height: 100%;
                background: rgba(0, 0, 0, 0.5); /* N�?�n b?�n trong su�?�t */
                display: none; /* �?�n theo m�??c ?��?�nh */
                justify-content: center;
                align-items: center;
                z-index: 9999; /* ?��?�m b�?�o n�??m tr?�n c??ng */
            }
            .overlay.active {
                display: flex; /* Hi�?�n th�?� l�?�p ph�?� khi active */
            }
            .overlay span {
                color: #fff;
                font-size: 24px;
...
<!--        <div id="navbar-container"></div>-->
        ...
        <div class="main">
            ...
            <div class="container-booking">
                ...
                <a href="javascript:void(0)" onclick="let ref = document.referrer; if(ref.includes('login') || ref.includes('register')) { window.location.href='home'; } else if(ref.includes(window.location.host)) { window.location.href=ref; } else { window.location.href='home'; }" class="btn-exit-booking" title="H�?�y ?��??t xe v?� quay l�?�i">
                    <i class="bi bi-x-lg"></i> H�?�y ?��??t xe
                </a>
                ...
                <form method="POST" id="signup-form" class="signup-form" action="">
                    ...
                    <div >
                        ...
                        <fieldset>
                            <h2>NG?�Y & GI�?�</h2>
                            <p class="desc">H?�y l�??a ch�?�n ng?�y gi�?� v?� ?��?�a ?�i�?�m b�?�n mu�?�n giao / tr�?� xe</p>
                            <div class="form-row">
                                <div class="form-flex">
                                    <div class="form-group">
                                        <label for="pickupdate" class="form-label">Ng?�y nh�?�n xe <span class="note-star"> *</span></label>
                                        <input type="date" name="pickupdate" id="pickupdate" />
                                    </div>
                                    <div class="form-group">
                                        <label for="pickuptime" class="form-label">Gi�?� nh�?�n xe <span class="note-star"> *</span></label>
                                        <input type="time" name="pickuptime" id="pickuptime"  />
                                        <small style="color: #888; font-size: 12px; margin-top: 5px; display: block;">* Gi�?� ho�?�t ?��?�ng: 07:00 - 23:00</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="returndate" class="form-label">Ng?�y tr�?� xe <span class="note-star"> *</span></label>
                                        <input type="date" name="returndate" id="returndate"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="returntime" class="form-label">Gi�?� tr�?� xe <span class="note-star"> *</span></label>
                            ...
                            <div class="form-row location">
                                <div class="form-flex">
                                    <div class="form-group">
                                        <label for="pickuplocation" class="form-label">?��?�a ?�i�?�m nh�?�n xe <span class="note-star"> *</span></label>
                                        <select name="pickuplocation" id="pickuplocation" class="form-label">
                                            <option value="Ga ?�?� N�??ng - S�?� 202 ?�??�?�ng H�?�i Ph??ng">Ga ?�?� N�??ng ?�� 202 H�?�i Ph??ng, Tam Thu�?�n</option>
                                            <option value="S?�n bay Qu�?�c t�?? ?�?� N�??ng - 132 Phan ?�?�nh Ph??ng">?�� S?�n bay ?�?� N�??ng ?�� 132 Phan ?�?�nh Ph??ng</option>
                                            <option value="B�??n xe Trung t?�m - 33 T??n ?��??c Th�?�ng">B�??n xe Trung t?�m ?�� 33 T??n ?��??c Th�?�ng, H�?�i Ch?�u</option>
                                            <option value="Ch�?� H?�n - 119 Tr�?�n Ph??">Ch�?� H?�n ?�� 119 Tr�?�n Ph??, H�?�i Ch?�u</option>
                                            <option value="Vincom Plaza - 910A Ng?? Quy�?�n">Vincom Plaza ?�� 910A Ng?? Quy�?�n, S?�n Tr?�</option>
                                            <option value="C�?�u R�?�ng - Tr�?�n H??ng ?��?�o">C�?�u R�?�ng ?�� Tr�?�n H??ng ?��?�o, H�?�i Ch?�u</option>
                                            <option value="Ng?? H?�nh S?�n - Huy�?�n Tr?�n C??ng Ch??a">Ng?? H?�nh S?�n ?�� Huy�?�n Tr?�n C??ng Ch??a</option>
                                            <option value="Lotte Mart - 6 N�?�i Nam">Lotte Mart ?�� 6 N�?�i Nam, H�?�i Ch?�u</option>
                                            <option value="Ph�?� ?�i b�?� B�?�ch ?��??ng - B�?�ch ?��??ng">Ph�?� ?�i b�?� B�?�ch ?��??ng, H�?�i Ch?�u</option>
                                            <option value="B�?�nh vi�?�n ?�?� N�??ng - 124 H�?�i Ph??ng">B�?�nh vi�?�n ?�?� N�??ng ?�� 124 H�?�i Ph??ng</option>
                                            <option value="Your own address">?��??� ?��?�a ch�?� c�?�a b�?�n (t�?? nh�?�p)</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="returnlocation" class="form-label">?��?�a ?�i�?�m tr�?� xe <span class="note-star"> *</span></label>
                        ...
                        <fieldset>
                            <h2>CH�?�N XE M?�Y</h2>
                            <p class="desc">H?�y ch�?�n nh�?�ng chi�??c xe tuy�?�t v�?�i nh�?�t cho h?�nh tr?�nh c�?�a b�?�n</p>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${not empty activeEvent and activeEvent.discount > 0}">
                                                                    <div style="display: flex; gap: 8px; align-items: baseline;">
                                                                        ...
                                                                        <span style="color: #dc2626; font-size: 14px; font-weight: bold; padding: 2px 6px; background: #fee2e2; border-radius: 4px;">Gi�?�m <fmt:formatNumber value="${activeEvent.discount * 100}" maxFractionDigits="0"/>%</span>
                                                                    </div>
                                                                    ...
                                                                    <h2 class="main-price price-day" >?�${discountedDay}00/Ng?�y</h2>
                                                                    <h2 class="main-price price-week" >?�${discountedWeek}00/Ng?�y</h2>
                                                                    <h2 class="main-price price-month" >?�${discountedMonth}00/Ng?�y</h2>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <h2 class="main-price price-day" >?�${p.dailyPriceForDay}00/Ng?�y</h2>
                                                                    <h2 class="main-price price-week" >?�${p.dailyPriceForWeek}00/Ng?�y</h2>
                                                                    <h2 class="main-price price-month" >?�${p.dailyPriceForMonth}00/Ng?�y</h2>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:if>
                                                    </c:forEach>                                             
                                                    <p class="price-note">Kh??ng bao g�?�m thu�?? v?� b�?�o hi�?�m</p>                                                    
                        ...
                        <fieldset>
                            <h2>PH�?� KI�?�N ?�I K?�M</h2>
                            <p class="desc">H?�y ch�?�n nh�?�ng ph�?� ki�?�n c?? th�?� gi??p ?�ch cho h?�nh tr?�nh c�?�a b�?�n</p>
...
<!--                                <h4>SERVICES</h4>
                                <div class="form-box">
                                    ...
                                    <div class="form-text">
                                        <h4>Xe ?�i ?�??�?�ng d?�i</h4>
                                        <div class="form-doc" style="box-sizing: border-box;">
                                            <p>Kho�?�n ph&iacute; n&agrave;y s�??&nbsp;&aacute;p d�?�ng&nbsp;cho c&aacute;c kh&aacute;ch h&agrave;ng
                                                s�?� d�?�ng xe m�?�t trong tr??�?�ng h�?�p sau:</p>
                                            <ul>
                                                <li>Kh&aacute;ch thu&ecirc; xe ?�i&nbsp;?�??�?�ng d&agrave;i, ra kh�?�i n�?�i th&agrave;nh Da Nang</li>
                                                <li>Xe ?�i ph??�?�t&nbsp;c&aacute;c t�?�nh ho�??c ?��??n c&aacute;c ?��?�a h&igrave;nh v&ugrave;ng n&uacute;i.
                                                </li>
                                            </ul>
                                            <p>L??u &yacute;: ?��?�i v�?�i c&aacute;c kh&aacute;ch&nbsp;?�i ?�??�?�ng d&agrave;i ch??a l�??a
                                                ch�?�n&nbsp;g&oacute;i ph&aacute;t sinh n&agrave;y, khi tr�?� xe COLORMOTOR s�?? thu b�?� sung c�?�a
                                                kh&aacute;ch. ?��?� bi�??t th&ecirc;m chi ti�??t&nbsp;vui l&ograve;ng li&ecirc;n h�?� <a
                                                    href="tel:0338023344">0338.02.33.44</a> ?��?� ?�??�?�c gi�?�i ?�&aacute;p.</p>
                                        </div>
                                    </div>
                                    <div class="form-check">
                                ...
                                <div class="form-box">
                                    ...
                                    <div class="form-text">
                                        <h4>B�?�o hi�?�m h�?�ng h??c 50k/ng?�y Yamaha Sirius & Honda Vision</h4>
                                        <div class="form-doc" style="box-sizing: border-box;">
                                            <p>Ph&iacute;&nbsp;50.000?�/ng&agrave;y &aacute;p d�?�ng cho d&ograve;ng xe Honda Airblade 125cc
                                                v&agrave; Winner 150cc</p>
                                            <p>Kho�?�n ph&iacute; n&agrave;y s�??&nbsp;&aacute;p d�?�ng&nbsp;cho c&aacute;c kh&aacute;ch h&agrave;ng
                                                s�?� d�?�ng xe m�?�t trong tr??�?�ng h�?�p sau:</p>
                                            <ul>
                                                <li>G&oacute;i b�?�o hi�?�m &aacute;p d�?�ng cho tr??�?�ng h�?�p kh&aacute;ch ?�i chuy�?�n g�??p b�?�t k�?? v�?�n ?��?�
                                                    g&igrave; h?? h�?�ng&nbsp;li&ecirc;n quan ?��??n xe m&aacute;y ?�ang thu&ecirc;, s�?? ?�??�?�c chi tr�?� 100%
                                                    s�?� ti�?�n s�?�a ch�?�a bao g�?�m c�?� v�?�n ?��?� va ch�?�m, tai n�?�n h?? h�?�i v�?� xe.</li>
                                            </ul>
                                            <p>L??u &yacute;: ?��?�i v�?�i c&aacute;c kh&aacute;ch&nbsp;?�i ?�??�?�ng d&agrave;i n&ecirc;n&nbsp;l�??a
                                                ch�?�n&nbsp;g&oacute;i ph&aacute;t sinh n&agrave;y&nbsp;?��?� an to&agrave;n v&agrave; y&ecirc;n
                                                t&acirc;m trong qu&aacute; tr&igrave;nh ?�i ph??�?�t,...</p>
                                        </div>
                                    </div>
                                    <div class="form-check">
                                        <div class="checkbox-container">
...
<!--                                                <input type="checkbox" id="daily-checkbox-${a.accessoryId}" class="option-checkbox">-->
                        ...
                        <fieldset>
                            ...
                            <p class="desc">H?�y x?�c nh�?�n ho�??c c�?�p nh�?�t th??ng tin c�?�a b�?�n</p>
                            <div class="fieldset-content">
                                <c:if test="${not empty sessionScope.account}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-flex">
                                            <div class="form-group">
                                                <label class="form-label">H�?� <span class="note-star"> *</span></label>
                                                <input type="text" name="first_name" id="first_name" value="${account.firstName}" oninput="validateForm()" />
                                              
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">T?�n <span class="note-star"> *</span></label>
...
<!--                                                <span class="text-input">Example :<span> Jeff@gmail.com</span></span>-->
                                            ...
                                            <div class="form-group">
                                                <label for="phonenumber" class="form-label">S�?� ?�i�?�n tho�?�i <span class="note-star"> *</span></label>
...
<!--                                                <span class="text-input">+84</span>-->
                                    ...
                                    <div class="form-row">
                                        <div class="form-group" style="width: 100%;">
                                            <label for="address" class="form-label">?��?�a ch�?� <span class="note-star"> *</span></label>
                                    ...
                                    <div class="form-row">
                                        <div class="form-flex">
                                            <div class="form-group">
                                                 <label for="birth_date" class="form-label">Ng?�y sinh <span class="note-star"> *</span></label>
                                                 <input type="date" name="dob" id="dob" value="${account.dob}" oninput="validateForm()" />
                                            </div>
                                            <div class="form-group">
                                                <label for="gender" class="form-label">Gi�?�i t?�nh <span class="note-star"> *</span></label>
                                                <div class="form-radio-group">   
                                                    <label><input type="radio" name="gender" value="Kh??ng mu�?�n ti�??t l�?�" ${account.gender == 'Kh??ng mu�?�n ti�??t l�?�' ? 'checked' : ''} onclick="validateForm()">B?� m�?�t</label>
                                                    <label><input type="radio" name="gender" value="Nam" ${account.gender == 'Nam' ? 'checked' : ''} onclick="validateForm()">Nam</label>
                                                    <label><input type="radio" name="gender" value="N�?�" ${account.gender == 'N�?�' ? 'checked' : ''} onclick="validateForm()">N�?�</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-enter">
                                                <div class="form-row">
                                                    <div class="form-flex">
                                                        ...
                                                        <div style="width: 60%; display: flex; gap: 20px;">
                                                            <div class="form-group" style="width: 50%">
                                                                <label for="issuedon" class="form-label">Ng?�y c�?�p <span class="note-star"> *</span></label>
                                                                <input type="date" name="issuedon" id="issuedon" value="${c.issuedOnDate}" oninput="validateForm()"/>
                                                            </div>
                                                            <div class="form-group" style="width: 50%">
                                                                <label for="expdate" class="form-label">Ng?�y h�??t h�?�n <span class="note-star"> *</span></label>
                                                    ...
                                                    <div class="form-row" style="margin-top: 25px;">
                                                        <label class="form-label" style="display: block; margin-bottom: 15px; font-weight: 600;">H?�nh �?�nh CCCD/CMND</label>
                                                        <div class="form-flex" style="align-items: flex-start;">
                                                            ...
                                                            <div class="upload-card-wrapper" style="flex: 1; min-width: 0;">
                                                                <label for="imageFront" class="upload-card">
                                                                    ...
                                                                    <span class="upload-title">C�?�p nh�?�t m�??t tr??�?�c</span>
                                                                    <span class="upload-subtitle">Nh�?�n ?��?� ch�?�n �?�nh m�?�i</span>
                                                                </label>
                                                                <input type="file" name="imageFront" id="imageFront" style="display: none;" />
                                                                
                                                                <!-- Preview Container (managed by JS) -->
                                                                <div class="image-preview-container" style="display: none;">
                                                                    <span class="existing-image-label">�?�nh m�??t tr??�?�c ?�?� ch�?�n:</span>
                                                                ...
                                                                <c:if test="${not empty imagesArr[0]}">
                                                                    ...
                                                                    <div class="image-preview-container existing-image">
                                                                        <span class="existing-image-label">M�??t tr??�?�c hi�?�n t�?�i:</span>
                                                            ...
                                                            <div class="upload-card-wrapper" style="flex: 1; min-width: 0;">
                                                                <label for="imageBack" class="upload-card">
                                                                    ...
                                                                    <span class="upload-title">C�?�p nh�?�t m�??t sau</span>
                                                                    <span class="upload-subtitle">Nh�?�n ?��?� ch�?�n �?�nh m�?�i</span>
                                                                </label>
                                                                ...
                                                                <!-- Preview Container (managed by JS) -->
                                                                <div class="image-preview-container" style="display: none;">
                                                                    <span class="existing-image-label">�?�nh m�??t sau ?�?� ch�?�n:</span>
                                                                    <img class="img-preview" src="" />
                                                                </div>
                                                                ...
                                                                <c:if test="${fn:length(imagesArr) gt 1 and not empty imagesArr[1]}">
                                                                    ...
                                                                    <div class="image-preview-container existing-image">
                                                                        <span class="existing-image-label">M�??t sau hi�?�n t�?�i:</span>
                                    ...
                                    <c:if test="${flag eq false}">
                                        ...
                                        <div style="margin-top: 10px; color: red">
                                            <a>*H?�y cung c�?�p th??ng tin CCCD/CMND c�?�a b�?�n ?��?� ti�??p t�?�c</a>
                                        </div>
                                        ...
                                        <div class="form-enter">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-row" style="margin-top: 25px;">
                                                    <label class="form-label" style="display: block; margin-bottom: 15px; font-weight: 600;">H?�nh �?�nh CCCD/CMND <span class="note-star"> *</span></label>
                                                    <div class="form-flex" style="align-items: flex-start;">
                                                        <div class="upload-card-wrapper" style="flex: 1; min-width: 0;">
                                                            <label for="imageFront" class="upload-card">
                                                                <i class="bi bi-person-vcard"></i>
                                                                <span class="upload-title">T�?�i l?�n m�??t tr??�?�c</span>
                                                                <span class="upload-subtitle">Nh�?�n ?��?� ch�?�n �?�nh</span>
                                                            </label>
                                                            <input type="file" name="imageFront" id="imageFront" style="display: none;" />
                                                        ...
                                                        <div class="upload-card-wrapper" style="flex: 1; min-width: 0;">
                                                            <label for="imageBack" class="upload-card">
                                                                <i class="bi bi-credit-card-2-back"></i>
                                                                <span class="upload-title">T�?�i l?�n m�??t sau</span>
                                                                <span class="upload-subtitle">Nh�?�n ?��?� ch�?�n �?�nh</span>
                                                            </label>
                                                            <input type="file" name="imageBack" id="imageBack" style="display: none;" />
                        ...
                        <h3>X?�c nh�?�n</h3>
                        <fieldset>
                            <h2>X?�C NH�?�N ?�?�N ?��??T XE</h2>
                            <p class="desc">H?�y x?�c nh�?�n th??ng tin v?� ?��?�ng ?? v�?�i c?�c ?�i�?�u kho�?�n d�?�ch v�?� </p>
                            <div class="fieldset-content">
                                <div class="scrollable-vertical">
                                    ...
                                    <div class="form-box" style="padding: 24px; background: #fff; border-radius: 12px; border: 1px solid #eaeaea; display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Ng?�y nh�?�n xe</label>
                                            <p id="pickupdatetext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Gi�?� nh�?�n xe</label>
                                            <p id="pickuptimetext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Ng?�y tr�?� xe</label>
                                            <p id="returndatetext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Gi�?� tr�?� xe</label>
                                            <p id="returntimetext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group" style="grid-column: span 2;">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">?��?�a ?�i�?�m nh�?�n xe</label>
                                            <p id="pickuploctext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group" style="grid-column: span 2;">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">?��?�a ?�i�?�m tr�?� xe</label>
                                    ...
                                    <div class="form-box" style="padding: 24px; background: #fff; border-radius: 12px; border: 1px solid #eaeaea; display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">H�?� v?� T?�n</label>
                                            <p style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"><span id="firstnametext"></span> <span id="lastnametext"></span></p>
                                        </div>
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Gi�?�i t?�nh</label>
                                        ...
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">S�?� ?�i�?�n tho�?�i</label>
                                            <p id="phonetext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Ng?�y sinh</label>
                                            <p id="birthdaytext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                        <div class="info-group" style="grid-column: span 2;">
                                            <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">?��?�a ch�?�</label>
                                            <p id="addresstext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                        </div>
                                    </div>
                                    <h4 style="margin-top: 25px;">TH?�NG TIN KH?�C</h4>
                                     <div class="form-box" style="padding: 24px; background: #fff; border-radius: 12px; border: 1px solid #eaeaea; display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                                         <div class="info-group" style="grid-column: span 2;">
                                             <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">S�?� CCCD/CMND</label>
                                             <p id="identityCardtext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                         </div>
                                         <div class="info-group">
                                             <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Ng?�y c�?�p</label>
                                             <p id="issuedontext" style="font-size: 16px; color: #333; font-weight: 600; margin: 0;"></p>
                                         </div>
                                         <div class="info-group">
                                             <label style="font-size: 12px; text-transform: uppercase; color: #888; font-weight: 700; display: block; margin-bottom: 6px;">Ng?�y h�??t h�?�n</label>
                                    ...
                                    <div class="form-box" style="padding: 12px 16px; background: #f9f9f9; border-radius: 8px; border: 1px solid #e0e0e0; margin-bottom: 12px;">
                                        <div style="display: flex; gap: 10px; align-items: center; width: 100%;">
                                            <input type="text" id="voucher-code-input" placeholder="Nh�?�p m?� voucher..."
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox-container">
                                            ...
                                            <label>?��?�ng ?? <a href="policies.jsp" target="_blank" style="color: #b59349; text-decoration: underline; font-weight: 600;">?�i�?�u kho�?�n d�?�ch v�?�</a></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                            <a onclick="yourFunctionName()">aaaaa</a>-->
                            <h2>THANH TO?�N C�?�C</h2>
                            <p class="desc">H?�y thanh to?�n s�?� ti�?�n c�?�c theo b?�n d??�?�i ?��?� ho?�n th?�nh ?�?�n ?��??t xe c�?�a b�?�n</p>
        ...
        <script>
            ...
            /*
            fetch('includes/navbar2.jsp')  // S�?� d�?�ng ?�??�?�ng d�?�n t???�ng ?��?�i
            .then(response => {
                if (!response.ok) {
            ...
            .then(html => {
                ...
                // Th?�m li?�n k�??t t�?�i th?? vi�?�n Bootstrap Icons
                ...
                // Copy c?�c th�?? link v?� script t�?� template v?�o shadow DOM
                ...
                // Copy n�?�i dung ch?�nh v?�o shadow DOM
            ...
            */
            ...
            (function ($) {
                ...
                $.validator.addMethod("businessHours", function(value, element) {
                    ...
                    return true;
                }, "Ch�?� nh�?�n/tr�?� xe trong gi�?� ho�?�t ?��?�ng (07:00 - 23:00)");
                ...
                form.children("div").steps({
                    ...
                    onStepChanged: function (event, currentIndex, priorIndex) {
                        ...
                        // Chuy�?�n c?�c chu�?�i ng?�y th?�nh ?��?�i t??�?�ng Date
...
//                            nextButton.style.color = '';
                       ...
                       if(currentIndex === 5){
                           ...
                           finishButton.style.display = 'none';
                            ...
                            // Truy�?�n d�?� li�?�u t�?� th�?? h2 v?�o iframe khi th�?? h2 thay ?��?�i
                            const sendDataToIframe = () => {
                                // L�?�y gi?� tr�?� c�?�a th�?? h2
                                const dataTotal = dataH2.textContent.replace(/[?�,.]/g, '').trim(); // L�?�y d�?� li�?�u v?� x??a d�?�u ch�?�m v?� d�?�u ch�?�m c?�u
                                console.log(dataTotal);
                                const data = {
                                    dataTotal: dataTotal
                                };
                                // Truy�?�n gi?� tr�?� v?�o iframe
                                iframe.contentWindow.postMessage(data, '*');
                            };

                            // G�?�i h?�m ?��?� g�?�i d�?� li�?�u ngay khi t�?�i trang
                            sendDataToIframe();

                            // Theo d??i s�?? thay ?��?�i c�?�a th�?? h2 v?� g�?�i d�?� li�?�u v?�o iframe
...
//                            nextButton.style.background = ''; nextButton.style.opacity = '1';
                        ...
                        if (currentIndex === 2) {
                            ...
                            // L�??p qua t�?�ng select box v?� l�?�y th??ng tin n�??u gi?� tr�?� l�?�n h?�n 0
                            ...
                            if(sum !== totalI){
                                ...
                                // ?��??t max v?� min cho c?�c input c?? class 'form-check-select'
...
//                        
                            // H?�m t�?�o c?�c t??y ch�?�n cho th�?? <select>
                            function createOptions(selectElement, min, max) {
                                selectElement.innerHTML = ''; // X??a c?�c t??y ch�?�n c?? n�??u c??
                        ...
                        if (currentIndex === 4) { // B??�?�c th�?? t?? (index b�?�t ?��?�u t�?� 0)
                            ...
                            toggleNextButton();
                            changePrice();
                            // L�?�y d�?� li�?�u ?�?� l??u t�?� localStorage v?� th?�m l�?�i v?�o savedItemsContainer
                            ...
                            //t�?�t c�?� c?�c select box trong div
                            const selectBoxes = checkboxMotorContainer.querySelectorAll('.form-check-select');
                            ...
                            selectBoxes.forEach(selectBox => {
                             ...
                             // Hi�?�n th�?� c?�c gi?� tr�?� ?�?� l??u trong numberMotorStates
                            if (numberMotorStates) {
                                Object.keys(numberMotorStates).forEach(numberId => {
                                    ...
                                    if (numberSelect) {
                                        ...
                                        numberSelect.disabled = true;  // N�??u b�?�n mu�?�n v?? hi�?�u h??a c?�c select box ?�?� ?�??�?�c l??u
                                    }
                                });
                            }
                            ...
                            // L�?�y t�?�t c�?� c?�c checkbox trong div
                            const checkboxes = checkboxContainer.querySelectorAll('.form-check-select');

                            // L�??p qua t�?�ng checkbox v?� l�?�y th??ng tin
                            ...
                            // Th?�m ti?�u ?��?� h4 v?� d�?� li�?�u s�?� l??�?�ng v�?�i gi?� ti�?�n v?�o div c�?� th�?� trong item-container
                            ...
                            savedBikeCal.forEach(formBox => { 
                                ...
                                // Quantity l?� s�?� ng?�y ch?�nh l�?�ch gi�?�a ng?�y tr�?� v?� ng?�y pickup
                                const quantityDay = Math.max(1, Math.ceil(differenceInDays)); // ?��?�m b�?�o quantity ?�t nh�?�t l?� 1
                            ...
                            // T�?�o th�?? div item-total v?� th?�m v?�o cu�?�i savedItemsContainer
                            ...
                            itemTotalContainer.innerHTML = discountHtml +
                                `<div style="display:flex; justify-content:space-between; width: 100%; align-items: center;">
                                    <h4 style="margin: 0; font-size: 18px; color: #333;">T�?�ng thanh to?�n:</h4>
                ...
                document.querySelectorAll('input[type="file"][name^="image"]').forEach(fileInput => {
                    fileInput.addEventListener('change', function(event) {
                        ...
                        if (file) {
                            ...
                            if (cardTitle) cardTitle.textContent = '?�� ?�?� ch�?�n: ' + file.name.substring(0, 20) + (file.name.length > 20 ? '...' : '');
                            if (cardSubtitle) cardSubtitle.textContent = 'Nh�?�n ?��?� thay ?��?�i �?�nh';
...
//                
//                // Th�??c hi�?�n c?�c h?�nh ?��?�ng c�?�n thi�??t t�?�i ?�?�y, v?� d�?�: t�?�t overlay sau 3 gi?�y
//                setTimeout(() => {
...
//                }, 30000000);
           ...
           // Ki�?�m tra n�??u c?? d�?� li�?�u n?�o ?�??�?�c g�?�i t�?� servlet
        ...
        function collectAccessoryData() {
            ...
            savedItemsContainer.querySelectorAll('.form-box').forEach(box => {
                ...
                // N�??u s�?� l??�?�ng l�?�n h?�n 0, th?�m v?�o danh s?�ch
                if (quantity > 0) {
                    accessories.push({
                        id: id,
...
//            alert("Thanh to?�n th?�nh c??ng v�?�i m?� giao d�?�ch: " + data.txnRef);
             // L�?�y c?�c gi?� tr�?� t�?� c?�c th�?? <p>
...
//                        const price = priceLabel ? priceLabel.textContent.replace('?�', '').replace('.000', '').trim() : 0;
            ...
            // G�?�i d�?� li�?�u t�?�i servlet b�??ng AJAX
            $.ajax({
                type: "POST",
                url: "bookinghandler", // Thay ?��?�i URL t�?�i servlet c�?�a b�?�n
...
//                contentType: "application/json",
        ...
        // N�??u d�?� li�?�u ?�?� c?? s�??n trong LocalStorage khi trang ?�??�?�c t�?�i l�?�i
        ...
        function applyVoucher() {
            ...
            if (!code) {
                ...
                msgEl.textContent = 'Vui l??ng nh�?�p m?� voucher';
                return;
            }
            msgEl.style.color = '#6b7280';
            msgEl.textContent = '?�ang ki�?�m tra...';
            ...
            .then(data => {
                if (data.valid) {
                    ...
                    msgEl.textContent = '?�� ?�p d�?�ng th?�nh c??ng! Gi�?�m ?�' + Number(data.discount).toLocaleString('vi-VN')
                        + (data.description ? ' ?�� ' + data.description : '');
                    document.getElementById('apply-voucher-btn').textContent = '?�?� ?�p d�?�ng';
            ...
            .catch(() => {
                msgEl.style.color = '#dc2626';
                msgEl.textContent = 'L�?�i k�??t n�?�i, vui l??ng th�?� l�?�i';
            });
        }
