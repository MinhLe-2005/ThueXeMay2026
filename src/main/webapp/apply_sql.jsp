...
"('VOU10K',10000,'Giảm giá 10,000 VNĐ cho mỗi đơn hàng','2024-05-11','Đang hoạt động',100,1,1),\n" +
"('SUMMER20',20000,'Giảm giá mùa hè 20,000 VNĐ','2024-06-01','Đang hoạt động',200,0,1);\n" +
"\n" +
"-- Booking\n" +
...
"(0,120000),(120000,150000),(150000,180000),(180000,210000),(210000,240000),(240000,270000),(270000,300000),(300000,NULL);";
    ...
    try (Connection conn = DBUtil.makeConnection()) {
        if (conn != null) {
            ...
            out.println("<h2>Update Database Data Successfully!</h2>");
        } else {
