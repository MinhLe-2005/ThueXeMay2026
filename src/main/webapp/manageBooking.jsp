    ...
    <body>
        ...
        <div class="container">
            <div class="pagetitle" style="margin-bottom: 20px; margin-top: 20px;">
                <h1 style="color: #1a1816; font-weight: 800; font-size: 24px; text-transform: uppercase; margin-top: 0; margin-bottom: 5px; font-family: 'Tahoma', sans-serif;">QUẢN LÝ ĐẶT XE</h1>
                <nav>
