...
<html lang="en">
    <head>
        ...
        <title>Đăng nhập - ColorBike</title>
    ...
    <body>
        <div class="login-wrapper">
            ...
            <div class="login-form-side animate__animated animate__fadeInLeft">
                ...
                <!-- Google Login -->
                <a class="btn-google-login" href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/MotorcyleHiringProject/login-google&response_type=code&client_id=158327451054-1sdvun9trsl75ng2i96pfmr9lsgrjnjb.apps.googleusercontent.com&approval_prompt=force">
